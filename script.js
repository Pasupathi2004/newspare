...
function updateUIForRole() {
  ...
  // Show all menu options for both admin and user accounts
  addButton.style.display = "block";
  deleteButton.style.display = "block";

  if (currentUser.role === "user") {
    updateButton.textContent = "📝 View/Update Item";
    updateQuantityBtn.style.display = "none"; // Hide Update Quantity for users
  } else {
    updateButton.textContent = "✏️ Update Item";
    updateQuantityBtn.style.display = "block"; // Show Update Quantity for admin
  }
}
...
function logout() {
  ...
  // First, hide all app sections properly - only target sections within appPage
